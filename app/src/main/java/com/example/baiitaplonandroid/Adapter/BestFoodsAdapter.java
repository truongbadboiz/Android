...
public BestFoodsAdapter(ArrayList<Foods> items){
    ...
    @Override
    public void onBindViewHolder(@NonNull BestFoodsAdapter.viewholder holder, @SuppressLint("RecyclerView") int position) {
  ...
  holder.startTxt.setText(""+items.get(position).getStar());
    ...
    TextView titleTxt,priceTxt,timeTxt,startTxt;
    ImageView pic;
